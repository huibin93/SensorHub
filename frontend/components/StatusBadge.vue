...
<template>
  <span v-if="status === FileStatus.Idle" class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-semibold bg-slate-100 text-slate-700">
    <Clock :size="12" /> Idle
  </span>
  ...
  <span v-else-if="status === FileStatus.Failed" 

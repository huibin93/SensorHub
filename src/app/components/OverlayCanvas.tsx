...
interface OverlayCanvasProps {
  ...
  // nearest point info computed by chart: { idx, time, x, points: [{series, value, x, y, color}] }
  nearestInfo?: { idx: number; time: number; x: number; points: { series: string; value: number; x: number; y: number; color: string }[] } | null;
...
export function OverlayCanvas({
  ...
  }, [width, height, annotations, viewport, hoveredRegionId, selectedRegionId, dragSelection, mousePosition, timeToPixel, nearestInfo]);
